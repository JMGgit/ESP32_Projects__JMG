 ...
 * */
static bool read_past_http_header(char text[], int total_len,
...
static bool connect_to_http_server() {
	ESP_LOGI(TAG, "Server IP: %s Server Port:%s", EXAMPLE_SERVER_IP,
			EXAMPLE_SERVER_PORT);
	...
	http_connect_flag = connect(socket_id, (struct sockaddr *) &sock_info,
			sizeof(sock_info));
...
void ota_example_task(void *pvParameter) {
	...
	int get_len = asprintf(&http_request, GET_FORMAT, EXAMPLE_FILENAME,
